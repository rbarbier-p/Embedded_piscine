...
void main(void)
{
  ...
  while (1) {
    SPI_APA102_start();
    SPI_APA102_frame(0x0F, 0x0, 0x0, 0xFF);
    ...
    SPI_APA102_start();
    SPI_APA102_frame(0x0, 0x0F, 0x0, 0xFF);
    SPI_APA102_frame(0x0, 0x0, 0x0, 0x0);
    SPI_APA102_frame(0x0, 0x0, 0x0, 0x0);
    SPI_APA102_stop(); 
    ...
    SPI_APA102_start();
    SPI_APA102_frame(0x00, 0x0, 0x0F, 0xFF);
    SPI_APA102_frame(0x0, 0x0, 0x0, 0x0);
    SPI_APA102_frame(0x0, 0x0, 0x0, 0x0);
    SPI_APA102_stop(); 
    ...
    SPI_APA102_start();
    SPI_APA102_frame(0x0F, 0xF, 0x0, 0xFF);
    SPI_APA102_frame(0x0, 0x0, 0x0, 0x0);
    SPI_APA102_frame(0x0, 0x0, 0x0, 0x0);
    SPI_APA102_stop(); 
    ...
    SPI_APA102_start();
    SPI_APA102_frame(0x0, 0xF, 0xF, 0xFF);
    SPI_APA102_frame(0x0, 0x0, 0x0, 0x0);
    SPI_APA102_frame(0x0, 0x0, 0x0, 0x0);
    SPI_APA102_stop(); 
    ...
    SPI_APA102_start();
    SPI_APA102_frame(0x0F, 0x0, 0xF, 0xFF);
    SPI_APA102_frame(0x0, 0x0, 0x0, 0x0);
    SPI_APA102_frame(0x0, 0x0, 0x0, 0x0);
    SPI_APA102_stop(); 
    ...
    SPI_APA102_start();
    SPI_APA102_frame(0x0F, 0x0F, 0x0F, 0xFF);
    SPI_APA102_frame(0x0, 0x0, 0x0, 0x0);
    SPI_APA102_frame(0x0, 0x0, 0x0, 0x0);
    SPI_APA102_stop(); 
